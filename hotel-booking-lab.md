...
> แทรกรูปภาพที่นี่ ![alt text](image.png)
...
> แทรกรูปภาพที่นี่ ![alt text](image-2.png) 
...
> แทรกรูปภาพที่นี่ ![alt text](image-6.png)
...
> แทรกรูปภาพที่นี่ ![alt text](image-7.png)
...
> แทรกรูปภาพที่นี่ ![alt text](image-8.png)
...
> แทรกรูปภาพที่นี่ ![alt text](image-9.png)
...
> แทรกรูปภาพที่นี่ ![alt text](image-10.png) ![alt text](image-11.png)
...
```
axios ใช้งานง่ายกว่าและเหมาะกับโปรเจกต์ที่ซับซ้อน ส่วน fetch ไม่ต้องติดตั้งอะไรเพิ่ม
```

**คำถามที่ 2:** เหตุใด `ProtectedRoute` จึงต้องตรวจสอบ `loading` state ก่อน ถ้าไม่ตรวจสอบจะเกิดอะไรขึ้น?

```
ต้องรอให้ loading เสร็จก่อน เพื่อให้ระบบรู้สถานะผู้ใช้จริง ๆ แล้วค่อยตัดสินใจว่าจะให้เข้าได้หรือ redirect
```

**คำถามที่ 3:** `localStorage` ที่ใช้เก็บ JWT token มีความเสี่ยงด้านความปลอดภัยอย่างไร และมีวิธีอื่นที่ดีกว่าหรือไม่?

```
localStorage ใช้ง่ายแต่เสี่ยง XSS มากกว่า การใช้ HttpOnly Cookie ปลอดภัยกว่าในระบบจริง
```
