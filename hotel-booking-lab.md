...
> แทรกรูปภาพที่นี่
![alt text](3-1.png)![alt text](3-2.png)![alt text](3-3.png)
---
...
> แทรกรูปภาพที่นี่
![alt text](10-1.png)![alt text](10-2.png)
---
...
> แทรกรูปภาพที่นี่
![alt text](14-1.png)![alt text](14-2.png)
---
...
```
เป็น Library ใช้รับ-ส่งข้อมูลกับ Server ครับ Axios 
สะดวกกว่าเพราะ แปลงข้อมูลเป็น JSON ให้เอง และจัดการ Error 
ได้ง่ายกว่า Fetch ที่ต้องเขียนโค้ดเช็คเองหลายขั้นตอน
```

**คำถามที่ 2:** เหตุใด `ProtectedRoute` จึงต้องตรวจสอบ `loading` state ก่อน ถ้าไม่ตรวจสอบจะเกิดอะไรขึ้น?

```
เพราะการเช็คสถานะล็อกอินต้องใช้เวลา ถ้าไม่เช็ค loading 
ระบบจะเข้าใจผิดว่ายังไม่ได้ล็อกอิน 
แล้วเด้งผู้ใช้ออกจากหน้าเว็บทันที ทั้งที่ข้อมูลยังโหลดไม่เสร็จ
```

**คำถามที่ 3:** `localStorage` ที่ใช้เก็บ JWT token มีความเสี่ยงด้านความปลอดภัยอย่างไร และมีวิธีอื่นที่ดีกว่าหรือไม่?

```
เสี่ยงครับ เพราะโดนแฮกเกอร์เขียนสคริปต์ (XSS) ขโมย Token 
ไปได้ง่าย วิธีที่ดีกว่าคือเก็บใน HttpOnly Cookie 
เพราะสคริปต์ทั่วไปจะแอบอ่านค่าไม่ได้ ปลอดภัยกว่ามาก
```
