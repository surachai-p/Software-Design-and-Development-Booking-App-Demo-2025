...
> ![LAB2-2 result](/image/LAB2-2.png)
...
> ![2.3.1 result](/image/LAB2.3.1.png)
...
> ![2.3.2 result](/image/LAB2.3.2.png)
...
> ![2.3.3 result](/image/LAB2.3.3.png)
...
> ![2.3.4 result](/image/LAB2.3.4.png)
...
> ![2.3.5 result](/image/LAB2.3.5.png)
...
> 
![GET-api-users](/image/GET-api-users.png)
![DELETE-by](/image/DELETE-by.png)
---
...
> 
![LAB3.3.3.1 (1)](/image/LAB3.3.1%20(1).png)
![LAB3.3.3.1 (2)](/image/LAB3.3.1%20(2).png)
![LAB3.3.3.1 (3)](/image/LAB3.3.1%20(3).png)
...
>
![LAB3.3.3.2 (1)](/image/LAB3.3.2%20(1).png)
![LAB3.3.3.2 (2)](/image/LAB3.3.2%20(2).png)
...
> ![LAB3.3.3.3 (1)](/image/LAB3.3.3%20(1).png)

### 📸 บันทึกผลการทดลอง: หน้าแก้ไขข้อมูลการจอง

> ![LAB3.3.3.3 (2)](/image/LAB3.3.3%20(2).png)
...
```
axios คือ Library เสริมที่ต้องติดตั้งเพิ่ม มันทำหน้าที่แปลงข้อมูลเป็น JSON อัตโนมัติ และสามารถดักจับ Error เช่น 404 หรือ 505 ได้ทันที 
ต่างจาก Fetch เพราะ Fetch เป็นฟังก์ชันพื้นฐานที่ติดมากับ Browser ไม่ต้องติดตั้งอะไรเพิ่ม แต่เราต้องแปลง JSON และเช็ก Error ด้วยตัวเอง
เนื่องจาก Fetch ไม่มองว่า HTTP Error คือข้อผิดพลาด หากเรายังเชื่อมต่อกับ Server ได้
```

**คำถามที่ 2:** เหตุใด `ProtectedRoute` จึงต้องตรวจสอบ `loading` state ก่อน ถ้าไม่ตรวจสอบจะเกิดอะไรขึ้น?

```
เพราะปกติถ้าไม่ตรวจสอบ ระบบจะตัดสินว่าเรายังไม่ได้ Login และนำเราไปหน้า Login ทันทีที่เปิดเว็บ ทั้งที่บางทีเราอาจจะ Login ค้างไว้
จึงต้องมี ProtectedRoute เพื่อมาเตือนระบบก่อนว่าให้ตรวจสอบสิทธิ์ให้แน่ใจ ก่อนตัดสินใจอีกที
```

**คำถามที่ 3:** `localStorage` ที่ใช้เก็บ JWT token มีความเสี่ยงด้านความปลอดภัยอย่างไร และมีวิธีอื่นที่ดีกว่าหรือไม่?

```
มีความเสี่ยงตรงที่โดนขโมยง่ายและอาจถูกสวมรอย
โดนขโมยง่าย เพราะ หากมีคนเอาโค้ดแปลกปลอมมาคอมเมนต์ในเว็บเรา ถ้าไม่ได้กรองดี ๆ ก็โดนขโมยได้ง่าย ๆ เลย
อาจถูกสวมรอย เพราะ หาก Hacker ได้ Token ไป สามารถนำไปใช้เข้าถึงข้อมูลของเราจากที่ไหนก็ได้จนกว่า Token จะหมดอายุ

วิธ๊ที่ปลอดภัย คือ HttpyOnly Cookie ซึ่งเป็นคุกกี้ประเภทพิเศษ มันจะกั้นไม่ให้โค้ด Javascript ฝั่ง Client สามารถอ่านหรือเขียนข้อมูลได้ และถึงแม้ Hacker จะฝังโค้ดบนเว็บเราได
แต่ก็เข้าเอา Token ออกไปไม่ได้ เพราะ เบราว์เซอร์จะปฏิเสธการเข้าถึงจากสคริปต์ทุดชนิด
```
